...
#include "src/descriptorset/VulkanDescriptorSet.h"
...
namespace Vixen {
    ...
    void VulkanCommandBuffer::beginRenderPass(
        ...
        for (auto i = 0; i < attachments.size(); i++) {
            const auto &[loadAction, storeAction, loadStoreTarget, resolveTarget, clearColor, clearDepth, clearStencil] = attachments[i];
