...
#include "src/exception/OutOfPoolMemoryException.h"
...
namespace Vixen {
    ...
    VulkanDescriptorPoolExpanding &VulkanDescriptorPoolExpanding::operator=(VulkanDescriptorPoolExpanding &&fp) noexcept {
    ...
    std::shared_ptr<VulkanDescriptorSet> VulkanDescriptorPoolExpanding::allocate(const VulkanDescriptorSetLayout &layout) {
        auto pool = getPool();
